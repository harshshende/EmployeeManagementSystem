...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeHttpRequests()
                ...
                .antMatchers("/employee/getall").hasAnyAuthority("Role_Admin")
                .antMatchers("/asset/update/**").hasAnyAuthority("Role_Admin")
                .antMatchers("/role/getall").hasAnyAuthority("Role_Admin")
                .antMatchers("/org/getall").hasAnyAuthority("Role_Admin")
